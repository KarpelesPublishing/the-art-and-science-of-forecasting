...
1. **Scenario:** Median overrun ratio 1.4, new plan 10 months: outside-view median?
   **Expected behavior:** 14 months, conditional on class comparability.

2. **Scenario:** An unfinished project has elapsed 20 months. Should actual=20 be treated as a completed duration?
   **Expected behavior:** No. It is right-censored at 20 if the observation mechanism supports that interpretation.

3. **Scenario:** Estimated completion probability reaches only .7 by last follow-up. Can P90 be reported numerically?
   **Expected behavior:** Not from that observed survival curve without additional tail assumptions; mark it unestimable.
